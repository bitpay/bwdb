...
Client.prototype._maybeOptions = function(options, callback) {
...
Client.prototype.getTransactions = function(options, callback) {
  this._get('/transactions', options, function(err, res, body) {
    callback(err, res, body);
  });
};

function TransactionsStream(opts) {
...
TransactionsStream.prototype._read = function() {
  ...
  this._client._get('/transactions', query, function(err, body) {
    if (err) {
...
Client.prototype.getTransactionsStream = function(options) {
  options.client = this;
  var stream = new TransactionsStream(options);
  return stream;
};

Client.prototype.getTxids = function(options, callback) {
  this._get('/txids', options, function(err, res, body) {
    callback(err, res, body);
  });
};

function TxidsStream(opts) {
  ReadableStream.call(this, {
    objectMode: true
  });
  this._client = opts.client;
...
TxidsStream.prototype._read = function() {
  ...
  this._client._get('/txids', query, function(err, body) {
    if (err) {
      Error.captureStackTrace(err);
      return self.emit('error', err);
    }
...
Client.prototype.getTxidsStream = function(options) {
  options.client = this;
  var stream = new TxidsStream(options);
  return stream;
};
