...
/**
 * Used for persisting private and public keys and the associated address.
 * @param options
 * @param options.address - The base58 encoded address
 * @param options.privateKey - The hex encoded private key string
 * @param options.publicKey - The hex encoded public key string
 */
