...
WalletUTXOBySatoshis.fromBuffer = function(key, value, network) {
  ...
  var txid = keyBuf.slice(40, 72);
  var index = keyBuf.readUInt32BE(72);
...
WalletUTXOBySatoshis.getKey = function(walletId, satoshis, txid, index) {
...
WalletUTXOBySatoshis.prototype.getKey = function() {
  return WalletUTXOBySatoshis.getKey(this.walletId, this.satoshis, this.txid, this.index);
};
