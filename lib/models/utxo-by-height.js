...
WalletUTXOByHeight.fromBuffer = function(key, value, network) {
  ...
  var height = keyBuf.readUInt32BE(32); // read 4 bytes
  var txid = keyBuf.slice(36, 68);
  var index = keyBuf.readUInt32BE(68);
...
WalletUTXOByHeight.getKey = function(walletId, height, txid, index) {
...
WalletUTXOByHeight.prototype.getKey = function() {
  return WalletUTXOByHeight.getKey(this.walletId, this.height, this.txid, this.index);
};
