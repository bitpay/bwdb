...
function Client(options) {
  ...
  assert(options, 'first argument is expected to be options');
  assert(options.network, '"network" is an expected option');
  assert(_.isString(options.network), '"network" is expected to be a string ("livenet", "testnet" or "regtest")');
