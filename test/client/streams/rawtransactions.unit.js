...
var RawTransactionsStream = require('../../../lib/client/streams/rawtransactions');

describe('Wallet Client RawTransactions Stream', function() {
    ...
    it('will call client get with query options', function(done) {
      ...
      stream.on('end', function() {
        ...
        client._get.args[0][0].should.equal(
          '/wallets/66bd1364ee6bf85733ba7541b3d29f5252429d7e31feab149eaaa0c75f09c003/rawtransactions'
        );
